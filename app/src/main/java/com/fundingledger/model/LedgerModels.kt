...
object SeedData {
    fun ledger(): Ledger = Ledger(
        target = 277_500.0,
        // Latest hand-entered gold price; SAR/g derives from this (≈ 496.95).
        xauUsd = 4121.40,
        pricePerGramOverride = null,
        rows = listOf(
            Row("cash-riyadh", "Cash Riyadh", Category.GREEN, Mode.FIXED, amount = 21_000.0, inTransfer = true),
            Row("cash-sy-usd", "Cash SY (USD-Val)", Category.GREEN, Mode.FIXED, amount = 75_000.0),
            Row("inma-bank", "Inma Bank 001", Category.GREEN, Mode.FIXED, amount = 0.0),
            Row("cash-usd-ksa", "Cash USD KSA (16K USD)", Category.GREEN, Mode.FIXED, amount = 21_750.0, inTransfer = true),
